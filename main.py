...
flags.DEFINE_integer('c0_dim', 2, 'dimension of stage1 generator input code variable c0 [2]')
flags.DEFINE_integer('c1_dim', 10, 'dimension of stage2 generator input code variable c1 [10]')
...
flags.DEFINE_integer('g0_nepoch', 51, 'number of epochs to use during training of stage-1 GAN [51]')
flags.DEFINE_integer('g1_nepoch', 51, 'number of epochs to use during training of stage-2 GAN [51]')
